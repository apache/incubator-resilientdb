...
def main():
    ...
    parser.add_argument("impacted", type=int, help="Number of impact replicas (integer)")
    parser.add_argument("delay", type=int, help="Message Delay (integer)")
    ...
    generate_config(config_path = config_path, max_process_txn = max_process_txn, 
                    network_delay_num=impacted, mean_network_delay=delay)
