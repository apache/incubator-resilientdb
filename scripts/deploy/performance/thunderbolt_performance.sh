export server=//benchmark/protocols/thunderbolt:kv_server_performance
...
#bazel run //benchmark/protocols/pbft:kv_service_tools -- $PWD/config_out/client1.config 
#bazel run //benchmark/protocols/pbft:kv_service_tools -- $PWD/config_out/client2.config 
#bazel run //benchmark/protocols/pbft:kv_service_tools -- $PWD/config_out/client3.config 
