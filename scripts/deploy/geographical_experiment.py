...
def generate_performance_server_conf(num_london, output_file = "./config/performance.conf"):
    """
    ...
    input_file_dict["./config/us-east-1-machines"] = 31-num_london
    input_file_dict["./config/eu-west-2-machines"] = num_london
...
def main():
    ...
    parser.add_argument("num_london", type=int, help="Number of london replicas (integer)")

    args = parser.parse_args()

    protocol = args.protocol
    num_london = args.num_london
    ...
    generate_performance_server_conf(num_london)
