...
def main():
    ...
    parser.add_argument("num_slow", type=int, help="Number of slow leaders (integer)")
    parser.add_argument("timer_length", type=str, help="Timeout length (integer)")
    ...
    generate_config(config_path = config_path, max_process_txn = max_process_txn, timer_length = timer_length, non_responsive_num = num_slow)
