...
scp -i ~/.ssh/ssh-2022-03-24.key /home/ubuntu/nexres/oracle_script/pbft/rep_4/server.config ubuntu@${ip}:/home/ubuntu &
scp -i ~/.ssh/ssh-2022-03-24.key /home/ubuntu/nexres/oracle_script/pbft/rep_4/cert/node_${idx}.key.pri ubuntu@${ip}:/home/ubuntu/pbft_cert/ &
scp -i ~/.ssh/ssh-2022-03-24.key /home/ubuntu/nexres/oracle_script/pbft/rep_4/cert/cert_${idx}.cert ubuntu@${ip}:/home/ubuntu/pbft_cert/ &
	((count++))
	((count++))
	((count++))
	((count++))
