...
uint64_t ResDBConfig::GetTimerLength() const {
  return config_data_.timer_length();
}

void ResDBConfig::SetTimerLength(uint64_t value) {
  config_data_.set_timer_length(value);
}
