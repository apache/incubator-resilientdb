...
void Write(const uint256_t& key, const uint256_t& value, int version, ResLevelDB * db){
...
void InternalReset(const uint256_t& key, const uint256_t& value, int64_t version,
  std::map<uint256_t, std::pair<uint256_t,int64_t> > * db, std::shared_mutex * mutex, ResLevelDB * storage ) {
...
int64_t LevelDB_D_Storage::StoreWithVersion(const uint256_t& key, const uint256_t& value, int version, bool is_local) {
...
int64_t LevelDB_D_Storage::Store(const uint256_t& key, const uint256_t& value, bool is_to_local_view) {
...
std::pair<uint256_t,int64_t> LevelDB_D_Storage::Load(const uint256_t& key, bool is_local_view) const {
...
int64_t LevelDB_D_Storage::GetVersion(const uint256_t& key, bool is_local) const{
  int idx = GetHashKey(key);
  if(is_local){
...
void LevelDB_D_Storage::Reset(const uint256_t& key, const uint256_t& value, int64_t version, bool is_local){
  int idx = GetHashKey(key);
  if(is_local){
