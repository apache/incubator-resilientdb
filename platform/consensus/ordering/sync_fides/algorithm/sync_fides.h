...
#include "platform/consensus/ordering/sync_fides/algorithm/utility.h"

namespace resdb {
namespace sync_fides {

class SyncFides : public common::ProtocolBase {
 public:
  SyncFides(int id, int f, int total_num, SignatureVerifier* verifier,
