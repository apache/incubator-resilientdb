...
class SlotHotStuff1: public common::ProtocolBase {
 public:
  SlotHotStuff1(int id, int f, int total_num, SignatureVerifier* verifier, int non_responsive_num, int fork_tail_num, int rollback_num, uint64_t timer_length);
  ~SlotHotStuff1();
