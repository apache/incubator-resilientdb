...
#include "platform/consensus/ordering/thunderbolt/executor/manager/streaming_dq_controller.h"
#include "platform/consensus/ordering/thunderbolt/executor/manager/utils.h"
...
class XExecutor : public ContractCommitter {
 ...
 private:
  ...
  LockFreeQueue<std::unique_ptr<ExecutionContext>> request_queue_;
