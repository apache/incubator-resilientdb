...
SequentialConcurrencyCommitter::SequentialConcurrencyCommitter(
    DataStorage* storage, GlobalState* global_state, int worker_num)
...
void SequentialConcurrencyCommitter::AddTask(
    int64_t commit_id, std::unique_ptr<ExecutionContext> context) {
...
ExecutionContext* SequentialConcurrencyCommitter::GetTaskContext(
    int64_t commit_id) {
...
SequentialConcurrencyCommitter::ExecContract(
