 ...
 * under the License.
 */
#include "platform/consensus/ordering/thunderbolt/executor/x_manager/v_controller.h"
...
VController::VController(DataStorage* storage)
...
const ConcurrencyController::ModifyMap* VController::GetChangeList(
    int64_t commit_id) const {
  return &changes_list_[commit_id];
}

void VController::PushCommit(int64_t commit_id,
