...
TwoPhaseOOOController::TwoPhaseOOOController(DataStorage * storage) : ConcurrencyController(storage){}
...
void TwoPhaseOOOController::PushCommit(int64_t commit_id, const ModifyMap& local_changes) {
