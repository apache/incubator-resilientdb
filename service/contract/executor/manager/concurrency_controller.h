...
struct Data{
  ...
  Data(const State& state, const uint256_t& data, int64_t version, const
uint256_t& old_data) :state(state), data(data), version(version),
old_data(old_data){} bool operator != (const Data& d) const{ return d.state !=
this->state || d.data != this->data || d.version != this->version;
    }
};
*/
