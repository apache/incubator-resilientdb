...
</svg>`}function f(t){return t.replace(/\u0026/g,"&amp;").replace(/\u003C/g,"&lt;").replace(/\u003E/g,"&gt;").replace(/\u0022/g,"&quot;").replace(/\u0027/g,"&apos;")}function y(t){let e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz",i="";for(let n=0;n<t;n++)i+=e.charAt(Math.floor(Math.random()*e.length));return i}function R({label:t,status:e}){return(t?`${t}: `:"")+e}function B(t,e){if(!t)throw new TypeError(e)}typeof window=="object"&&(window.badgen=E);0&&(module.exports={badgen,calcWidth});
