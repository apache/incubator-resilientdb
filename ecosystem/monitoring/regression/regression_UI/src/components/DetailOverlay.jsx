 ...
 * DetailOverlay.jsx
 * 
 * Modal overlay component displaying detailed performance analysis for a specific test run.
 * Renders comprehensive diagnostics including:
 * - Performance metrics (latency, throughput, success rate, consensus time)
 * - Latency percentiles (p50, p95, p99)
 * - System diagnostic insights from AI analysis
 * - Historical baseline comparisons (performance trends vs. previous runs)
 * - Anomaly detection results
 * - Recommendations and warnings
 * - Raw JSON data export
 * 
 * Triggered by clicking on a data point in the main monitor chart.
 */
