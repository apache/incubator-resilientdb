...
from sdk_validator.resdb_validator.crypto import PrivateKey, hash_data
from sdk_validator.resdb_validator.exceptions import (KeypairMismatchException,
                                          InputDoesNotExist, DoubleSpend,
                                          InvalidHash, InvalidSignature,
                                          AmountError, AssetIdMismatch,
                                          ThresholdTooDeep)
from sdk_validator.resdb_validator.utils import serialize
...
class Input(object):
    ...
    Wraps around a Crypto-condition Fulfillment.
        ...
        Attributes:
            ...
            fulfills (:class:`~resdb_validator.transaction. TransactionLink`,
